...
def main():
    ...
    final_df.to_csv(
        RESULTS_DIR / "s2_architecture_comparison_summary.csv",
        index=False,
    )

    window_summary_df.to_csv(
        RESULTS_DIR / "s2_architecture_comparison_windows.csv",
        index=False,
    )

    routing_df.to_csv(
        RESULTS_DIR / "s2_architecture_comparison_routing.csv",
        index=False,
    )

    all_trades_df.to_csv(
        RESULTS_DIR / "s2_architecture_comparison_trades.csv",
        index=False,
    )
