...
def main():
    ...
    final_df.to_csv(
        "s2_selective_execution_summary.csv",
        index=False,
    )

    window_df.to_csv(
        "s2_selective_execution_windows.csv",
        index=False,
    )

    A_all.to_csv(
        "s2_selective_execution_A_trades.csv",
        index=False,
    )
    ...
    AB_all.to_csv(
        "s2_selective_execution_AB_trades.csv",
        index=False,
    )
    ...
    routing_df.to_csv(
        "s2_selective_execution_routing.csv",
        index=False,
    )
