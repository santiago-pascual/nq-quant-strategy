...
def main():
    ...
    bootstrap_df.to_csv(
        RESULTS_DIR / "s2_statistical_bootstrap.csv",
        index=False,
    )
    ...
    block_df.to_csv(
        RESULTS_DIR / "s2_statistical_block_bootstrap.csv",
        index=False,
    )
    ...
    mc_df.to_csv(
        RESULTS_DIR / "s2_statistical_monte_carlo.csv",
        index=False,
    )

    monthly.to_csv(RESULTS_DIR / "s2_statistical_monthly.csv")
